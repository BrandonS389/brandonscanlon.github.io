...
#define SAVE_DATA_UPON_RESET_REG 100u       /* 16-bit parameter register.
...
#define MAXIMUM_SET_SPEED_REG 106u          /* 16-bit parameter register.
                                             * Can be programmed with values
                                             * of 00 to 5500 (0.0 - 550.0) Hz.
                                             * Address 1.06. (User save.) */

#define MINIMUM_SET_SPEED_REG 107u          /* 16-bit parameter register.
                                             * Can be programmed with values
...
#define PRESET_SPEED_SELECTOR_REG 115u      /* 16-bit parameter register.
                                             * Can be programmed with values of
                                             * preset reference 0 to preset
                                             * reference 8.
                                             * Address 1.15. (User save.) */

#define	PRESET_SPEED_ONE_REG 121u           /* 16-bit parameter register.
                                             * Can be programmed with values
                                             * of -5500 to +5500.
                                             * (-550.0 to +550.0) Hz.
                                             * Address 1.21. (User save.) */

#define	PRESET_SPEED_TWO_REG 122u           /* 16-bit parameter register.
                                             * Can be programmed with values
                                             * of -5500 to +5500.
                                             * (-550.0 to +550.0) Hz.
                                             * Address 1.22. (User save.) */

#define	PRESET_SPEED_THREE_REG 123u         /* 16-bit parameter register.
                                             * Can be programmed with values
                                             * of -5500 to +5500
                                             * (-550.0 to +550.0) Hz.
...
#define RAMP_HOLD_REG 203u                  /* 16-bit parameter register.
                                             * Can be programmed with values of
                                             * 0 (off) or 1 (on).
                                             * Address 2.03. (User save) */

#define S_RAMP_ENABLE_REG 206u              /* 16-bit parameter register.
                                             * Can be programmed with values of
                                             * 0 (off) or 1 (on).
                                             * Address 2.06. (User save) */

#define S_RAMP_ACCELERATION_LIMIT_REG 207u  /* 16-bit parameter register.
                                             * Can be programmed with values of
                                             * 00 to 3000.
                                             * (0.0 to 300.0 seconds^2)/100Hz.
                                             * Address 2.07. (User save.) */

#define ACCELERATION_RATE_SELECTOR_REG 210u /* 16-Bit parameter register.
                                             * Can be programmed with values of
                                             * 0 to 9.
                                             * Address 2.10. (User save.) */

#define ACCELERATION_RATE_ONE_REG 211u      /* 16-bit parameter register.
                                             * Can be programmed with values of
                                             * 00 to 32000.
...
#define ACCELERATION_RATE_TWO_REG 212u      /* 16-bit parameter register.
                                             * Can be programmed with values of
                                             * 00 to 32000.
                                             * (0.0 to 3200.0 * the resolution
                                             * specified by Pr 2.39)s/Hz.)
...
#define ACCELERATION_RATE_THREE_REG 213u    /* 16-bit parameter register.
                                             * Can be programmed with values of
                                             * 00 to 32000.
                                             * (0.0 to 3200.0 * the resolution
                                             * specified by Pr 2.39)s/Hz.)
...
#define ACCELERATION_RATE_FOUR_REG 214u     /* 16-bit parameter register.
                                             * Can be programmed with values of
                                             * 00 to 32000.
                                             * (0.0 to 3200.0 * the resolution
                                             * specified by Pr 2.39)s/Hz.)
...
#define ACCELERATION_RATE_FIVE_REG 215u     /* 16-bit parameter register.
                                             * Can be programmed with values of
                                             * 00 to 32000.
                                             * (0.0 to 3200.0 * the resolution
                                             * specified by Pr 2.39)s/Hz.)
...
#define ACCELERATION_RATE_SIX_REG 216u      /* 16-bit parameter register.
                                             * Can be programmed with values of
                                             * 00 to 32000.
                                             * (0.0 to 3200.0 * the resolution
                                             * specified by Pr 2.39)s/Hz.)
...
#define ACCELERATION_RATE_SEVEN_REG 217u    /* 16-bit parameter register.
                                             * Can be programmed with values of
                                             * 00 to 32000.
                                             * (0.0 to 3200.0 * the resolution
                                             * specified by Pr 2.39)s/Hz.)
...
#define ACCELERATION_RATE_EIGHT_REG 218u    /* 16-bit parameter register.
                                             * Can be programmed with values of
                                             * 00 to 32000.
                                             * (0.0 to 3200.0 * the resolution
                                             * specified by Pr 2.39)s/Hz.)
...
#define DECELERATION_RATE_SELECTOR_REG 220u /* 16-Bit parameter register.
                                             * Can be programmed with values of
                                             * 0 to 9.
                                             * Address 2.20. (User save.) */

#define DECELERATION_RATE_ONE_REG 221u      /* 16-bit parameter register.
                                             * Can be programmed with values of
                                             * 00 to 32000.
                                             * (0.0 to 3200.0  * the resolution
...
#define DECELERATION_RATE_TWO_REG 222u      /* 16-bit parameter register.
                                             * Can be programmed with values of
                                             * 00 to 32000.
                                             * (0.0 to 3200.0  * the resolution
                                             * specified by Pr 2.39)/Hz.)s/Hz.)
...
#define DECELERATION_RATE_THREE_REG 223u    /* 16-bit parameter register.
                                             * Can be programmed with values of
                                             * 00 to 32000.
                                             * (0.0 to 3200.0  * the resolution
                                             * specified by Pr 2.39)/Hz.)s/Hz.)
...
#define DECELERATION_RATE_FOUR_REG 224u     /* 16-bit parameter register.
                                             * Can be programmed with values of
                                             * 00 to 32000.
                                             * (0.0 to 3200.0  * the resolution
                                             * specified by Pr 2.39)/Hz.)s/Hz.)
...
#define DECELERATION_RATE_FIVE_REG 225u     /* 16-bit parameter register.
                                             * Can be programmed with values of
                                             * 00 to 32000.
                                             * (0.0 to 3200.0  * the resolution
                                             * specified by Pr 2.39)/Hz.)s/Hz.)
...
#define DECELERATION_RATE_SIX_REG 226u      /* 16-bit parameter register.
                                             * Can be programmed with values of
                                             * 00 to 32000.
                                             * (0.0 to 3200.0  * the resolution
                                             * specified by Pr 2.39)/Hz.)s/Hz.)
...
#define DECELERATION_RATE_SEVEN_REG 227u    /* 16-bit parameter register.
                                             * Can be programmed with values of
                                             * 00 to 32000.
                                             * (0.0 to 3200.0  * the resolution
                                             * specified by Pr 2.39)/Hz.)s/Hz.)
...
#define DECELERATION_RATE_EIGHT_REG 228u    /* 16-bit parameter register.
                                             * Can be programmed with values of
                                             * 00 to 32000.
                                             * (0.0 to 3200.0  * the resolution
                                             * specified by Pr 2.39)/Hz.)s/Hz.)
...
#define RAMP_RATE_UNITS_REG 239u        /* 16-bit parameter register.
...
#define MOTOR_RATED_FREQUENCY_REG   506u    /* 16-bit parameter register.
                                             * Can be programmed with values of
                                             * 00.0 550.0 Hz.
                                             * Address 5.06. (User save.) */

#define MOTOR_RATED_CURRENT_REG 507u        /* 16-bit parameter register.
                                             * Can be programmed with values of
                                             * 000 to the VFD rated current.
                                             * (0.00 to rated current)
                                             * Address 5.07. (User save.) */

#define MOTOR_RATED_FULL_LOAD_RPM_REG 508u  /* 16-bit parameter register.
                                             * Can be programmed with values of
                                             * 0 to 9999 RPM.
                                             * Address 5.08. (User save.) */

#define MOTOR_RATED_VOLTAGE_REG 509u        /* 16-bit parameter register.
                                             * Can be programmed with values of
                                             * 0 to VFD rated output voltage
                                             * Address 5.09. (User save.) */

#define MOTOR_RATED_POWER_FACTOR_REG 510u   /* 16-bit parameter register.
                                             * Can be programmed with values of
                                             * 000 to 100.
                                             * (0.00 to 1.00)
                                             * Address 5.10. (User save.) */

#define DYNAMIC_V_TO_F_SELECT_REG 513u      /* 16-bit parameter register.
                                             * Can be programmed with values of
                                             * 0 (off) or 1 (on).
                                             * Address 5.13. (User save.) */

#define SLIP_COMPENSATION_ENABLE_REG 527u   /* 16-bit parameter register.
                                             * Can be programmed with values of
                                             * 0 (off) or 1 (on).
...
#define START_STOP_LOGIC_SELECT_REG 604u    /* 16-bit parameter register.
                                             * Can be programmed with values of
...
#define SEQUENCER_LATCHING_ENABLE_REG 640u  /* 16-bit parameter register.
                                             * Can be programmed with values of
                                             * 0 (off) or 1 (on).
                                             * Address 6.40. */

#define DRIVE_CTRL_WORD_REG 642u            /* 16-bit parameter register.
                                             * Can be programmed with values of
                                             * 0 to 32767.
                                             * Address 6.42. */

#define CTRL_WORD_ENABLE_REG 643u           /* 16-bit parameter register.
                                             * Can be programmed with values of
                                             * 0 (off) or 1 (on).
                                             * Address 6.43. */
...
#define MOTORIZED_POT_RATE_REG 923u         /* 16-bit parameter register.
                                             * Can be programmed with values of
                                             * 0 to 250 seconds from 0% to 100%.
                                             * Address 9.23. (User save.) */

#define MTR_POT_DESTINATION_REG 925u        /* 16-bit parameter register.
                                             * Can be programmed with values of
                                             * 000 to 2151.
...
#define MOTORIZED_POT_UP_REG 926u           /* 16-bit parameter register.
                                             * Can be programmed with values of
                                             * 0 (off) or 1 (on).
                                             * Address 9.26. */

#define MOTORIZED_POT_DOWN_REG 927u         /* 16-bit parameter register.
                                             * Can be programmed with values of
                                             * 0 (off) or 1 (on).
                                             * Address 9.27. */

#define MOTORIZED_POT_RESET_REG 928u        /* 16-bit parameter register.
                                             * Can be programmed with values of
                                             * 0 (off) or 1 (on).
                                             * Address 9.28. */
...
#define USER_TRIP_REG 1038u                 /* 16-bit parameter register.
...
#define DRIVE_CONFIGURATION_REG 1127u       /* 16-bit parameter register.
                                             * Can be programmed with values of
...
#define	LOAD_DEFAULTS_REG 1143u             /* 16-bit parameter register.
                                             * Can be programmed with values of
                                             * 0 (no), 1 (Eur) or 2 (USA).
...
#define VARIABLE_SELECTOR_1_SOURCE_1_REG 1208u
...
#define VARIABLE_SELECTOR_1_SOURCE_2_REG 1209u
                                            /* 16-bit parameter register.
                                             * Can be programmed with values of
                                             * 000 to 2151.
                                             * Appropriate values of
...
#define VARIABLE_SELECTOR_1_MODE_REG 1210u  /* 16-bit parameter register.
                                             * Can be programmed with values of
...
#define VARIABLE_SELECTOR_1_DESTINATION_REG 1211u
                                            /* 16-bit parameter register.
                                             * Can be programmed with values of
                                             * 000 to 2151.
                                             * Appropriate values of
...
#define VARIABLE_SELECTOR_1_SOURCE_1_SCALING_REG 1213u
                                            /* 16-bit parameter register.
                                             * Can be programmed with values of
                                             * -4000 to +4000.
                                             * (-4.000 to +4.000)
...
#define VARIABLE_SELECTOR_1_SOURCE_2_SCALING_REG 1214u
                                            /* 16-bit parameter register.
                                             * Can be programmed with values of
                                             * -4000 to +4000.
                                             * (-4.000 to +4.000)
